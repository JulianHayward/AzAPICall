...
$script:ModuleVersion = (Import-PowerShellDataFile -Path "$($script:ModuleRoot)\AzApiCall.psd1").ModuleVersion

# Detect whether at some level dotsourcing was enforced
$script:doDotSource = Get-PSFConfigValue -FullName AzApiCall.Import.DoDotSource -Fallback $false
if ($AzApiCall_dotsourcemodule) { $script:doDotSource = $true }
